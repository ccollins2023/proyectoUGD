...
let Profesor = class Profesor extends typeorm_1.BaseEntity {
};
...
__decorate([
    (0, typeorm_1.Column)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'La profesión es obligatoria' }),
    (0, class_validator_1.Length)(3, 100, { message: 'La profesión debe tener entre 3 y 100 caracteres' }),
    __metadata("design:type", String)
], Profesor.prototype, "profesion", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'El teléfono es obligatorio' }),
    (0, class_validator_1.IsNumberString)({}, { message: 'El teléfono debe contener solo números' }),
    (0, class_validator_1.Length)(7, 15, { message: 'El teléfono debe tener entre 7 y 15 caracteres' }),
    __metadata("design:type", String)
